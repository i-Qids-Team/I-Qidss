...
class VegetableData {
  ...
  List<VegetableModel> _question = [
    VegetableModel('1/5) I look like a tree', 'assets/broccoli.gif',
        'Pickles', 'Broccoli', 2),
    VegetableModel('2/5) I am long and purple. Who am I?',
        'assets/eggplant2.gif', 'Eggplant', 'Pineapple', 1),
    VegetableModel('3/5) I have a big seed. Who am I?', 'assets/avocado.gif',
        'Broccoli', 'Avocado', 2),
    VegetableModel('4/5) People cry when they cut me. Who am I?',
        'assets/onion.gif', 'Onion', 'Mushroom', 1),
    VegetableModel('5/5) You use me in salad. Who am I?',
